...
class CuaSoNiemTinQuanSatMotPhan:
    def __init__(self, chuong_trinh):
        ...
        # Tiêu đề
        nhan_tieu_de = ttk.Label(self.cua_so, text="Tìm kiếm Niềm tin Quan sát Một phần", font=phong_chu_dam)
    ...
    def khoiDongThuatToan(self):
        ...
        thuat_toan = partially_observable_search.POMDPBeliefStateSearchAlgorithm()
        duong_di, chi_phi, bo_dem, do_sau, thoi_gian_chay, tong_khong_gian = thuat_toan.POMDPBeliefStateSearch(
    ...
    def moCuaSoNiemTinQuanSatMotPhan(self, su_kien=None):
        self.cua_so.deiconify()

if __name__ == "__main__":
    goc = tk.Tk()
    ung_dung = CuaSoNiemTinQuanSatMotPhan(goc)
    goc.mainloop()