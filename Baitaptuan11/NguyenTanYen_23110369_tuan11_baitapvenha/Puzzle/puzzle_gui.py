...
class PuzzleGUI:
    ...
    def setup_gui(self):
        ...
        algorithms = [
            ...
            "AND-OR Graph Search", "Belief-State Search"
        ]
    ...
    def solve(self):
        ...
        if algorithm == "BFS":
            ...
            solved = self.solver.and_or_graph_search(initial_state, goal_board)
        elif algorithm == "Belief-State Search":
            solved = self.solver.belief_state_search(initial_state, goal_board)
        else:
